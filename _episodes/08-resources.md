...
There are more advanced uses of OpenRefine, such as importing column or cell data via web locators (URLs or APIs). The links above can give you a start on your journey.
